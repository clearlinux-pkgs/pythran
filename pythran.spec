...
%prep
%setup -q -n pythran-0.9.11
cd %{_builddir}/pythran-0.9.11
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1624296451
...
cp %{_builddir}/pythran-0.9.11/LICENSE %{buildroot}/usr/share/package-licenses/pythran/6a7b1189c16283fa7f28dbdadda64777c82412a2
cp %{_builddir}/pythran-0.9.11/docs/LICENSE.rst %{buildroot}/usr/share/package-licenses/pythran/0fcc278a4a3d0341c919d405ce4a80f9c20f7c0c
